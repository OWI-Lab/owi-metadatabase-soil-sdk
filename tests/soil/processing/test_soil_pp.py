...
from owi.metadatabase.soil import SoilDataProcessor, SoilprofileProcessor
...
def test_lateral_api2rpgeo(filename: str, mudline: float) -> None:
    ...
    if mudline is None:
        ...
        assert any("[mLAT]" in col for col in result.columns), (
        ...
        assert mudline - result.iloc[-1]["Elevation to [mLAT]"] == sp_depth, (
